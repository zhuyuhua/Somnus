...
final class RingBufferEventMatcher extends
		TypeSafeMatcher<RingBuffer<Object[]>> {
	...
	@Factory
	public static RingBufferEventMatcher ringBufferWithEvents(
			final Matcher<?>... valueMatchers) {
	...
	public void describeTo(final Description description) {
		...
		// CoreMatchers.allOf(expectedValueMatchers).describeTo(description);
