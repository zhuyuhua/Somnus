...
public class BankAccountTest {
	...
	// @Test
	public void should_transfer_settle_account_to_a_saving_account() throws Exception {
		Account settleAccount = Account.ofType(AccountType.SETTLE).withInitalBalance(1000);
		Account savingAccount = Account.ofType(AccountType.SAVING).withInitalBalance(2000);
