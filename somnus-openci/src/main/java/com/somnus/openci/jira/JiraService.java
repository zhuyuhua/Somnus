...
public class JiraService {
	...
	private static Logger logger = LoggerFactory.getLogger(JiraService.class);
	...
	public boolean isUserExist(String username_or_developId) {
		...
		try {
			...
			throw new RuntimeException("the token is invalid or the SOAP session has timed out,please login again.",
					e1);
	...
	public void addActorsToProjectRole(String projectKey, String userName, String projectRoleName)
		...
		jiraService.addActorsToProjectRole(token, new String[] { userName }, remoteProjectRole, remoteProject,
				actorType);
