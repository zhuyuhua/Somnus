package com.somnus.rpc.thrift.tutorial;
...
import com.somnus.rpc.thrift.tutorial.shared.SharedStruct;
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (args[0].contains("simple")) {
				...
				params.setTrustStore(JavaServer.keystore, "thrift", "SunX509",
						"JKS");
				/*
