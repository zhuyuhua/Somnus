 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from E:\\svn\\git\\Somnus\\somnus-example\\somnus-restli\\restli-api\\src\\main\\pegasus\\com\\example\\fortune\\Fortune.pdsc.", date = "Sun Jul 26 13:47:23 CST 2015")
public class Fortune extends RecordTemplate {
	...
	private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema(
			"{\"type\":\"record\",\"name\":\"Fortune\",\"namespace\":\"com.example.fortune\",\"doc\":\"Generate a fortune cookie\",\"fields\":[{\"name\":\"fortune\",\"type\":\"string\",\"doc\":\"The Fortune cookie string\"}]}"));
	...
	@Override
	public Fortune clone() throws CloneNotSupportedException {
		return ((Fortune) super.clone());
	}

	@Override
	public Fortune copy() throws CloneNotSupportedException {
