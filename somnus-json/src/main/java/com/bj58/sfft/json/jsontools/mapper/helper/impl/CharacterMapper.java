...
public class CharacterMapper extends AbstractMapper {
	...
	public Object toJava(JSONValue aValue, Class aRequestedClass) throws MapperException {
		if (!aValue.isString()) {
			throw new MapperException("CharacterMapper cannot map class: " + aValue.getClass().getName());
		}
		String lRepr = ((JSONString) aValue).getValue();
		if (lRepr.length() != 1) {
			throw new MapperException("CharacterMapper cannot map value: " + lRepr);
		}
		return Character.valueOf(lRepr.charAt(0));
	}
}